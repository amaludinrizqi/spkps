...
<head>
	...
	<title>SPKPS</title>
	<!-- Favicon -->
	<link href="{{ asset('public/assets/img/brand/favicon.png') }}" rel="icon" type="image/png">
	<!-- Fonts -->
							...
							<form role="form" method="POST" action="{{ route('register') }}">
								...
								<div class="form-group mb-3">
									<div class="input-group input-group-alternative">
										...
										<input placeholder="masukan nama.." id="nama" type="text" class="form-control top @error('nama') is-invalid @enderror"
										 name="name" value="{{ old('name') }}" required autocomplete="name" autofocus> @error('name')
								...
								<div class="form-group">
									<div class="input-group input-group-alternative">
										...
										<input placeholder="konfirmasi kata sandi" id="password-confirm" type="password" class="form-control" name="password_confirmation"
